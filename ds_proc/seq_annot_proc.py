...
with open('../data/rb_prof_Naef/processed_data/seq_annot_raw/ensembl_Tr_Seq_CTRL_merged.pkl', 'rb') as f:
...
with open('../data/rb_prof_Naef/processed_data/seq_annot_final/ensembl_Tr_Seq_CTRL_merged_final.pkl', 'wb') as f:
