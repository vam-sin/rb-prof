...
saved_files_name = architecture + '-' + dataset_name + '-' + feature_string + '-' + loss_func_name + '-BS' + str(bs) + '-LR_' + str(lr) + '-E_' + str(epochs) + '-LogNorm' + '-Dropout_' + str(dropout) + '-' + condition + '-AddCondsEmbeddingToDeprCodons'
