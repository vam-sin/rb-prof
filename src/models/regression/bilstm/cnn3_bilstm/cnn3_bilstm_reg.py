...
from model_utils import BiLSTMModel, train, evaluate, RBDataset_NoBS, BiLSTMModel_Norm
...
epochs = 50
bs = 1
saved_files_name = 'CNN3B-0-DS06-NT_CBERT-BS1-PCCLoss'
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        train_loss, train_pr, train_sr =  train(model, train_dataloader, bs, device, criterion, mult_factor, loss_mult_factor, optimizer, logger, epoch)
